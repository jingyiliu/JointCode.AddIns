...
namespace JointCode.AddIns.Loading
{
    ...
    class LoaderFactory
    {
    	...
    	readonly Dictionary<int, ExtensionLoaderFactory> _uid2ExLoaderFactories;
    	readonly Dictionary<int, ExtensionPointLoaderFactory> _uid2EpLoaderFactories;
    	
    	internal LoaderFactory(RuntimeAssemblyResolver asmResolver)
    	{
        ...
        internal void RegisterExtensionBuilder(ExtensionBuilderRecord ebRecord)
        {
            ...
            var assembly = _asmResolver.GetLoadedAssembly(ebRecord.AssemblyUid);
            ...
            var ebFactory = new ReflectionExtensionBuilderFactory();
            factory = Activator.CreateInstance(factoryType, ebFactory, ebType) as ExtensionLoaderFactory;
