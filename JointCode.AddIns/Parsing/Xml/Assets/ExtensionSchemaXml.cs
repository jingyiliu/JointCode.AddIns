...
namespace JointCode.AddIns.Parsing.Xml.Assets
{
    class ExtensionSchemaXml
    {
        ...
        internal bool TryParse(ResolutionResult resolutionResult, AddinResolution addin, 
            ...
            out List<ExtensionBuilderResolutionGroup> ebResolutionGroups)
        {
            ...
            if (_eps != null)
            {
                ...
                foreach (var ep in _eps)
                {
                    ...
                    result &= ep.TryParse(resolutionResult, addin, out epr);
                    if (!result)
                        break;
            ...
            if (_ebGroups != null)
            {
                ...
                foreach (var ebGroup in _ebGroups)
                {
                    ...
                    result &= ebGroup.TryParse(resolutionResult, addin, out ebrg);
                    if (!result)
                        break;
